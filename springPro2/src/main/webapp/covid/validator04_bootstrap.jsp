...
<head>
 ...
 <!-- jQuery (부트스트랩의 자바스크립트 플러그인을 위해 필요합니다) -->
     <!-- jQuery (부트스트랩의 자바스크립트 플러그인을 위해 필요합니다) -->
    <script src="${hContext}/resources/js/jquery-3.2.1.min.js"></script>
    <!-- jQuery validator -->
         ...
         function bindEventHandler(){
         	 ...
         	 $("#registerForm").validate({
                 ...
                 highlight: function ( element, errorClass, validClass ) {
                     $( element ).parents( ".col-lg-5 .col-md-5 .col-sm-5 .col-xs-5" ).addClass( "has-error" ).removeClass( "has-success" );
                 },
                 unhighlight: function (element, errorClass, validClass) {
                     $( element ).parents( ".col-lg-5 .col-md-5 .col-sm-5 .col-xs-5" ).addClass( "has-success" ).removeClass( "has-error" );
                 }
